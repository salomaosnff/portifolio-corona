            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-8">
                                <h1 class="display-3  text-white">Coronavírus
                                    <span>ajude-nos a vencer essa guerra</span>
                                </h1>
                                <p class="lead text-white">Cadastre suas iniciativas para oferecer soluções ou
